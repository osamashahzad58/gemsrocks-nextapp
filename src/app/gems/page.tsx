...
const page = () => {
    ...
    return (
        <>
            {/* {loader && <Loader />} */}
            <Navbar />
            <section className='Main_Gems'>
                <div className="custom-container">
                    <div className='Top_rocks'>
                        <div className='rocks_bgdiv'>
                            <h1 className='rockshtag'>Forged to Shine: </h1>
                            <h1>Discover the Gems </h1>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="custom-container">
                    <div className='bottom_rocks'>
                        <div className='input_main'>
                            ...
                            <button onClick={handleShow} className="Sort d-none">
                                Sort: {sortShow} <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
